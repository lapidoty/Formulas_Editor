...
const Buttons = () => {
  return (
    <ButtonGrid className="buttons">
      <Button type="MEMORY_ADD">IF</Button>
      <Button type="MEMORY_SUBTRACT">AND</Button>
      <Button type="MEMORY_RECALL">OR</Button>
      <Button type="MEMORY_CLEAR">XOR</Button>
      <Button type="SIGN">NOT</Button>
